...
import com.jodaehyeon.mmmmmm.databinding.WordRowBinding

class WordAdapter(private var wordList: ArrayList<Word>) :
    ...
    inner class ViewHolder(private val binding: WordRowBinding) :
